...
- _Italic_ for parameters/variables
- CAPS for categories
...
**Phase 2: Targeted Content Extraction (Pass 2)** 4. Extract key content from each high-importance section using subject-specific prompts:
...
**Phase 3: Content Prioritization & Compression (Pass 3)** 6. Score and rank all extracted items:
...
**Phase 4: Layout & Assembly** 9. Space budget management:
