...
export const MacbookScroll = ({
  ...
  onScreenImageClick,
  screenImageClickLabel = "Xem ảnh màn hình phóng to",
}: {
  src?: string;
  ...
  imageAlt?: string;
  onScreenImageClick?: () => void;
  screenImageClickLabel?: string;
}) => {
  ...
  return (
    ...
    >
      ...
      <Lid
        src={src}
        imageAlt={imageAlt}
        onScreenImageClick={onScreenImageClick}
        screenImageClickLabel={screenImageClickLabel}
        scaleX={scaleX}
        scaleY={scaleY}
        rotate={rotate}
        translate={translate}
    ...
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        {onScreenImageClick ? (
          <button
            type="button"
            onClick={onScreenImageClick}
            aria-label={screenImageClickLabel}
