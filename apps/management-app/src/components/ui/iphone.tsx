...
export type IphoneScreenImageFit = "cover" | "contain"

export interface IphoneProps extends HTMLAttributes<HTMLDivElement> {
  src?: string
  videoSrc?: string
  /** Alt text for screen image (PWA screenshot). */
  imageAlt?: string
  /** `contain` shows full screenshot inside the bezel (letterboxing). `cover` may crop. */
  imageFit?: IphoneScreenImageFit
  /** Extra classes for the screen &lt;img&gt; (e.g. fine-tune scale). */
  screenImageClassName?: string
}
      ...
      {!hasVideo && src && (
        <div
          className={cn(
            ...
            imageFit === "contain" && "bg-zinc-100 dark:bg-zinc-950",
          )}
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
