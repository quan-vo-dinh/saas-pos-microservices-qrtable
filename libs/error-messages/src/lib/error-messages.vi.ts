...
export const ERROR_MESSAGES_VI: Record<ErrorCode, string> = {
  ...
  [ErrorCode.PAYMENT_REFUND_ALREADY_EXISTS]: 'Đã có yêu cầu hoàn tiền cho thanh toán này',
  [ErrorCode.PAYMENT_REFUND_NOT_PENDING_STAFF_ACTION]: 'Yêu cầu hoàn tiền không chờ nhân viên xử lý',
  [ErrorCode.PAYMENT_NOT_WAITING_REFUND_CONFIRMATION]: 'Thanh toán không chờ xác nhận hoàn tiền',
