...
export const ERROR_MESSAGES_EN: Record<ErrorCode, string> = {
  ...
  [ErrorCode.PAYMENT_REFUND_ALREADY_EXISTS]: 'Refund already exists for this payment',
  [ErrorCode.PAYMENT_REFUND_NOT_PENDING_STAFF_ACTION]: 'Refund is not pending staff action',
  [ErrorCode.PAYMENT_NOT_WAITING_REFUND_CONFIRMATION]: 'Payment is not waiting for refund confirmation',
