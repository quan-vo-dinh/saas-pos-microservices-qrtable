...
| **Legacy specs (removed)** |                              6 | Đã cạnh tranh thẩm quyền với final behavior docs trước khi được hấp thụ và xóa                    |
| **docs/testing/**          |                              3 | Taxonomy, traceability và strategy là evidence bền vững sau khi bỏ execution artifacts            |
...
| -------------------------- | ---------------------------------------------- | ---------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Legacy specs (removed)** | Không giữ làm independent long-lived authority | Đã xóa sau khi accepted behavior được hấp thụ vào business/architecture/phase docs       | Vercel demo evidence được thay bằng Phase 7 operational records                                                                                                           |
| **docs/testing/**          | README, traceability matrix và Saga strategy   | Execution plans, handoff, mini-specs và duplicate inventory đã được hấp thụ rồi xóa      | Unresolved gaps tiếp tục được ghi trực tiếp trong traceability matrix                                                                                                     |
