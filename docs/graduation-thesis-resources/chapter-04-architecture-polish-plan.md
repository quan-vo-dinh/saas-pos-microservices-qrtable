...
- [x] Task 4: Thiết kế Hình 4.x "Bản đồ tích hợp công nghệ QRTable".
...
- [x] Task 5: Render và chèn technology integration map vào LaTeX.
...
3. Giữ overall/C4 diagram hiện có làm góc nhìn tổng thể; dùng technology integration map để giải thích công nghệ và luồng tích hợp.
...
- [x] Có technology integration map đã render và chèn vào PDF.
...
Đã triển khai ngày 2026-06-04. Phạm vi thực hiện đã mở rộng từ P0 sang nhóm P1 đã chốt trong thảo luận: rewrite Chương 4, thêm Bảng 4.1 quyết định công nghệ, thêm Hình 4.1 bản đồ tích hợp công nghệ, sửa Hình 4.2 overall architecture còn 5 Kafka topic được chấp nhận, bổ sung Hình 4.4 Nx module boundary, Hình 4.6 communication topology, Hình 4.8 Redis ownership, Hình 4.9 security/auth flow và Hình 4.10 SePay/VietQR payment architecture. Source Mermaid của bản đồ công nghệ và năm sơ đồ con đã lưu trong `thesis-report/assets/diagrams/`; PDF/PNG đã lưu trong `thesis-report/assets/figures/`; LaTeX build pass bằng XeLaTeX/TeX Live.
