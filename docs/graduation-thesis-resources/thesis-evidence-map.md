...
> Lần khảo sát gần nhất: 2026-07-13.
...
The maintained report baseline contains seven chapters. Dashboard/reporting, plan entitlement, and their evidence must be described only from the current report source, canonical technical documents, and verified artifacts; do not retain historical backfill status as current scope.
...
| Business flows                            | `docs/business-logic.md`; `docs/technical-architecture.md`; phase docs                                                                                                                                         | Cao                                        | Là nguồn chính cho table/session/order/kitchen/payment state machine.                                                                                                                               |
| Trạng thái triển khai nội bộ              | `docs/project-status.md`; `docs/phases/*.md`                                                                                                                                                                   | Cao                                        | Dùng cho AI/dev biết phần nào cần backfill. Không đưa nguyên văn trạng thái “TODO/deferred” vào bản khóa luận gửi thầy.                                                                             |
...
| Event-driven architecture                 | `docs/technical-architecture.md` mục 7; `docs/project-status.md`; Kafka-related tests                                                                                                                          | Cao                                        | Phải trình bày là selective event-driven architecture, không phải "mọi thứ đều async". Hiện có năm approved Kafka topics.                                                                           |
...
Nguồn kỹ thuật chính: `docs/testing/saga-validation-strategy.md`. Khi viết Chương 5 và Chương 6, không chứng minh Saga chỉ bằng việc nói “code có service tên Saga”. Cách chứng minh nên là chuỗi bằng chứng nhiều lớp:
