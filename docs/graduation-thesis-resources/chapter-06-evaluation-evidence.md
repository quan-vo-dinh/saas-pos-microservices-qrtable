...
| Authentication/RBAC           | Keycloak/JWT cho staff/admin, session guard cho customer, 6 roles/65 permissions verified                                           | Mạnh                                | Có thể viết là guard chain và permission seed đã được kiểm chứng bằng unit/contract/live smoke script. |
