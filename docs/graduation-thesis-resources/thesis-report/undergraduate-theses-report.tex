...
\input{include/screenshot-scaffold}
...
\newcommand{\thesisenglishtitle}{\textcolor{red}{Research on the Development of a SaaS-Based POS Platform Integrating QR Code Ordering under a Microservices Architecture}}
...
\input{chapters/02-co-so-ly-thuyet-va-cong-trinh-lien-quan}
\input{chapters/03-phan-tich-yeu-cau}
\input{chapters/04-thiet-ke-va-kien-truc-he-thong}
\input{chapters/05-trien-khai-he-thong}
\input{chapters/06-danh-gia}
\input{chapters/07-ket-luan-va-huong-phat-trien}
...
\input{appendices/f-benchmark-observability-evidence}
