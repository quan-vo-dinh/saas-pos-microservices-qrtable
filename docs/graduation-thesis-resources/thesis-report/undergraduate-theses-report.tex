...
% Build from this directory with: tectonic undergraduate-theses-report.tex
...
\newcommand{\thesisstudentid}{<MÃ SỐ SINH VIÊN>}
\newcommand{\thesisfaculty}{<KHOA>}
\newcommand{\thesismajor}{<TÊN NGÀNH>}
\newcommand{\thesissupervisor}{<TÊN GIẢNG VIÊN HƯỚNG DẪN>}
