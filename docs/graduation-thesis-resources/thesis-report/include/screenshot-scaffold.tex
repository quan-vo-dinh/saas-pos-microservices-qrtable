...
% Legacy helpers (appendix generator / old drafts)
...
% --- Capture guide, hidden when \screenshotplaceholderfalse ---
\newcommand{\screenshotcaptureguide}[1]{%
  ...
  Khi đã có ảnh thật, giữ \texttt{\textbackslash screenshotplaceholderfalse} trong \texttt{screenshot-scaffold.tex} để ẩn khối ghi chú này.
