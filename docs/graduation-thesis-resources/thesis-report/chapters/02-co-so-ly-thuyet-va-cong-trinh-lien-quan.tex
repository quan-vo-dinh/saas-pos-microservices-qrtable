...
Mô hình nhiều đơn vị thuê bao không chỉ là một lựa chọn về cơ sở dữ liệu. Nó liên quan đến API, xác thực, phân quyền, bộ nhớ đệm, sự kiện, phòng thời gian thực, tải tệp và cả tham chiếu thanh toán. Nếu chỉ lọc dữ liệu ở cơ sở dữ liệu nhưng khóa bộ nhớ đệm hoặc phòng WebSocket không gắn không gian tên đơn vị thuê bao, hệ thống vẫn có nguy cơ lộ dữ liệu chéo đơn vị thuê bao. Vì vậy, cô lập dữ liệu theo đơn vị thuê bao phải được xem là ràng buộc bất biến xuyên suốt kiến trúc.
...
\begin{itemize}
  ...
  \item Mức độ hoàn thiện của Saga và outbox được đánh giá theo bằng chứng triển khai và kiểm thử tương ứng.
\end{itemize}
