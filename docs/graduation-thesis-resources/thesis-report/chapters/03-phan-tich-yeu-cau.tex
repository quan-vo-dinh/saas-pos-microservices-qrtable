...
\addlinespace
FR-ORD-01 & Phiên và giỏ chung & Khách cùng bàn phải dùng chung phiên/giỏ; các thao tác giỏ hàng phải kiểm soát phiên bản để tránh ghi đè khi nhiều thiết bị cùng thao tác. & Cập nhật giỏ lỗi thời bị từ chối và phía giao diện phải lấy lại ảnh chụp trạng thái từ máy chủ. \\
\addlinespace
...
\addlinespace
FR-PAY-02 & Lịch sử thanh toán và đối soát & Chủ quán/quản lý xem lịch sử thanh toán theo tenant ở chế độ chỉ đọc để đối soát vận hành; điều chỉnh sau thanh toán không thuộc phạm vi luận văn. & Dữ liệu lịch sử phải được lọc theo tenant; không cho phép sửa trạng thái thanh toán qua giao diện lịch sử. \\
\addlinespace
...
Nhóm yêu cầu nhân sự chỉ được trình bày ở mức quản lý nhân sự trong tenant. Chủ quán và quản lý có thể quản lý nhân sự theo ma trận phân quyền, trong đó chủ quán có quyền thao tác nhạy hơn như xóa người dùng hoặc cập nhật vai trò, còn quản lý bị giới hạn ở các thao tác vận hành được cấp. Phạm vi này không bao gồm quy trình quản trị nhân sự nâng cao (HRM) như bảng lương, ca làm, chấm công hoặc phụ thuộc vào dịch vụ email/thông báo.
...
Nhóm bảng điều khiển và báo cáo bổ sung khả năng đọc hiểu vận hành sau khi dữ liệu giao dịch đã phát sinh. Ở mức yêu cầu, báo cáo của QRTable là mô hình dữ liệu đọc chỉ đọc do các miền sở hữu dữ liệu cung cấp, ví dụ miền Thanh toán cho doanh thu đã thanh toán, miền Đơn cho đơn/hóa đơn, miền Thực đơn cho bàn/thực đơn và miền SaaS cho số liệu nền tảng. Điều này không đồng nghĩa hệ thống có dịch vụ phân tích số liệu riêng, kho dữ liệu OLAP hoặc quy trình phân tích nghiệp vụ riêng trong phạm vi Chương 3.
...
\section{Ranh giới phạm vi và giới hạn của các khẳng định đánh giá}

Phân tích yêu cầu cần xác định rõ phạm vi để các chương sau không đánh giá vượt quá bằng chứng. Trong phạm vi chính của khóa luận, QRTable tập trung vào POS SaaS cho F\&B, đặt món qua QR tại bàn, quản lý tenant/gói thuê bao, quản lý nhân sự trong tenant, thực đơn/bàn/QR, giỏ chung/đơn, KDS, quyết toán thanh toán, bản MVP của bảng điều khiển và báo cáo, RBAC và cô lập tenant. Các yêu cầu này có đủ cơ sở để tiếp tục thiết kế kiến trúc, trình bày triển khai và đánh giá bằng ma trận truy vết, kiểm thử và kịch bản minh họa ở các chương sau.
...
Thứ hai, khả năng quan sát vận hành và triển khai chỉ nên được viết ở mức thiết kế hoặc phạm vi minh họa có giới hạn nếu chưa có bảng điều khiển, truy vết, quy trình thu thập nhật ký và quy trình triển khai được kiểm chứng đầy đủ. Các cụm như sẵn sàng cao, kỹ thuật chaos hoặc giám sát cấp vận hành thực tế không phù hợp nếu không có bằng chứng độc lập.

Thứ ba, hành vi ngoại tuyến trong phạm vi hiện tại chỉ nên hiểu là suy giảm chức năng, kết nối lại và làm mới giao diện. Hàng đợi thao tác ngoại tuyến đầy đủ, đồng bộ nền và bộ giải xung đột cho mọi thao tác khách, POS hoặc KDS là hướng phát triển, không thuộc yêu cầu đánh giá chính của đề tài. Tương tự, các nội dung như giới hạn tốc độ quét QR theo bàn, dịch vụ thông báo, email biên lai, email chào mừng/tạm ngưng/đặt lại mật khẩu, nhiều ngân hàng thanh toán đồng thời, hoàn một phần gói thuê bao, tồn kho/BOM nâng cao, thuế/kế toán, quản trị nhân sự nâng cao (HRM), bảng lương, lập ca, quản trị quan hệ khách hàng (CRM), ứng dụng di động gốc và tích hợp sâu với nền tảng giao đồ ăn bên thứ ba không thuộc phạm vi kết quả chính của Chương 3.

Thứ tư, bảng điều khiển và báo cáo trong phạm vi hiện tại chỉ là bản MVP cho báo cáo vận hành và phân tích số liệu nền tảng, dựa trên mô hình dữ liệu đọc của các dịch vụ sở hữu dữ liệu. Các năng lực như phân tích nghiệp vụ hoặc trí tuệ nhân tạo nâng cao (BI/AI), kho dữ liệu phân tích, OLAP, xuất báo cáo theo lịch, phân tích hiệu suất nhân sự, dự báo hoặc phát hiện bất thường, phân tích nhóm tenant/khách hàng nâng cao, kênh thời gian thực cho bảng điều khiển hoặc dòng doanh thu thời gian thực là ngoài phạm vi đánh giá chính nếu chưa có bằng chứng tương ứng.
