...
\addlinespace
FR-PAY-02 & Hoàn tiền và đối soát & Chủ quán/quản lý có thể xử lý hoàn tiền trong phạm vi hiện tại là hoàn toàn bộ thủ công; lịch sử thanh toán phục vụ đối soát vận hành. & Hoàn tiền không mở lại hóa đơn và không tạo nhiều hoàn tiền đang hiệu lực trên cùng một thanh toán. \\
\addlinespace
...
\addlinespace
Vòng đời hóa đơn/thanh toán & \texttt{OPEN}, \texttt{PENDING\_PAYMENT}, \texttt{PAID}; hoàn tiền toàn bộ thủ công & Yêu cầu hóa đơn cần giỏ rỗng và đơn đã phục vụ xong; thanh toán xong đóng hóa đơn/phiên và chuyển bàn sang dọn dẹp; webhook trùng phải idempotent. \\
\bottomrule
\end{longtable}
