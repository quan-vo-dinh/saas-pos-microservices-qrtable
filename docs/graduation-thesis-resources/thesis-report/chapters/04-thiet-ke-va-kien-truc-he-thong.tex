...
HTTP/API ngoài & Catalog / Payment / Authorizer -- Cloudinary / SePay / Keycloak & Tải ảnh, API OAuth/nhà cung cấp và thao tác quản trị IAM. & Phạm vi đánh giá phụ thuộc vào mã nguồn, kiểm thử và hiện vật nhà cung cấp tương ứng. \\
\end{longtable}
}
...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.13\textwidth}>{\raggedright\arraybackslash}p{0.16\textwidth}>{\raggedright\arraybackslash}p{0.17\textwidth}>{\raggedright\arraybackslash}p{0.19\textwidth}>{\raggedright\arraybackslash}p{0.2\textwidth}}
  ...
  \midrule
  \endhead
  Khách hàng & PWA khách qua BFF & Token QR/bàn và phiên & Bàn, phiên và đơn vị thuê bao hiện tại & Không có vai trò RBAC trong \texttt{role.json}; hành vi được giới hạn theo phiên và quyền sở hữu. \\
...
BFF tập trung các mối quan tâm bảo mật xuyên suốt như xác thực, ngữ cảnh đơn vị thuê bao, quyền thao tác, quyền theo gói, định tuyến webhook và cầu nối thời gian thực. Các bất biến về đơn, tồn kho, thanh toán, gói thuê bao và dữ liệu báo cáo vẫn thuộc về dịch vụ sở hữu tương ứng.
...
Ma trận quyền đầy đủ của QRTable được lưu trong tài liệu kiến trúc RBAC. Trong thiết kế này, khách hàng không thuộc \texttt{role.json} mà được kiểm soát theo phiên và quyền sở hữu. Nhân viên, chủ quán, quản lý và quản trị viên nền tảng sử dụng vai trò cùng quyền do Keycloak và User-Access phối hợp cung cấp cho BFF.
...
Thiết kế triển khai tạo nền tảng cho trình diễn và thu thập hiện vật trên môi trường công khai. Tính sẵn sàng cao, khả năng chịu tải, kiểm thử gây lỗi có chủ đích, thời gian hoạt động và khả năng phục hồi cần môi trường cùng quy trình kiểm chứng riêng nên không thuộc kết quả của mục này.
