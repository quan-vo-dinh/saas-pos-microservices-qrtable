...
Các công nghệ trong Bảng~\ref{tab:chapter4-technology-decision} được đặt trong mối quan hệ với mục tiêu thiết kế, vị trí sử dụng và giới hạn kỹ thuật. Đối với Nx, tài liệu chính thức mô tả khả năng quản lý đồ thị dự án, xác định phần bị ảnh hưởng, bộ nhớ đệm tác vụ và thư viện dùng chung trong monorepo \cite{nx-docs-2026}. Các khả năng này phù hợp với nhu cầu quản lý nhiều ứng dụng và thư viện của QRTable trong cùng kho mã nguồn.
...
Hình~\ref{fig:chapter4-technology-integration-map} đặt các công nghệ vào năm lớp kiến trúc: ứng dụng người dùng, lớp biên, dịch vụ miền nghiệp vụ, hạ tầng dữ liệu và sự kiện, cùng nhà cung cấp ngoài. Các luồng chính thể hiện ứng dụng truy cập qua BFF, dịch vụ giao tiếp nội bộ bằng TCP/gRPC, Kafka truyền một số sự kiện miền, Redis giữ bộ nhớ đệm hoặc trạng thái khi vận hành, và webhook thanh toán được BFF định tuyến đến Payment hoặc SaaS.
...
Hình~\ref{fig:chapter4-overall-architecture} tóm tắt kiến trúc tổng thể theo các lớp ứng dụng người dùng, BFF, dịch vụ miền nghiệp vụ và hạ tầng. Hình~\ref{fig:chapter4-c4-container} trình bày hệ thống ở mức container theo C4, qua đó làm rõ tác nhân, ứng dụng web, dịch vụ, kho lưu trữ và hệ thống ngoài. Vai trò của từng lớp được mô tả dưới đây.
