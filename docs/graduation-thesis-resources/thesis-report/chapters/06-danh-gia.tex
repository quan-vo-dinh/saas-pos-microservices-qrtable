...
Trong phần đánh giá định lượng, khóa luận sử dụng k6, một công cụ nguồn mở dùng để kiểm thử tải và hiệu năng. Công cụ này mô phỏng tải bằng người dùng ảo (Virtual User -- VU), thực thi các kịch bản được mô tả bằng mã và thu thập các chỉ số như số yêu cầu mỗi giây, độ trễ, tỷ lệ lỗi và tỷ lệ các phép kiểm tra đạt yêu cầu. Đối với QRTable, k6 không thay thế kiểm thử chức năng; nó tạo tải cho ba kịch bản đại diện và cung cấp số liệu để đối chiếu với Prometheus, Grafana và Tempo ở phần sau của chương.
...
\section{Đánh giá kiến trúc và vận hành thử nghiệm}
...
Bên cạnh các tiêu chí về ranh giới dịch vụ và khả năng bảo trì, Bảng~\ref{tab:chapter6-k6-benchmark-summary} cung cấp phần đo định lượng bằng k6 cho một số luồng đại diện trên môi trường cục bộ. Phần này không lặp lại số liệu đo tải, mà diễn giải ý nghĩa của chúng đối với hiệu năng, khả năng mở rộng và triển khai thử nghiệm.
