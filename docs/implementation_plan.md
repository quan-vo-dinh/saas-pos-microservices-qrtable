...
| --- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| 1   | Kafka 4P+2AP       | Current Kafka topics: order.confirmed, order.status_changed, payment.completed, payment.refunded, kitchen.sla_warning, tenant.created. UI-only events use BFF Direct, Redis internal hints, or socket emits after commit; `order.status_changed` is the durable Order outbox exception, not the immediate UI push path.                                                                                 | [§7.2-7.4](technical-architecture.md) |
